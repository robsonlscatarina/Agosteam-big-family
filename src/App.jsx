...
const TEAM = {
  ...
  pmtech:   { id:"pmtech",   name:"Bebel",    role:"PM Técnico",                         color:"#86EFAC", bg:"#14532D", emoji:"🛠️", desc:"PM com forte base técnica. Traduz requisitos de produto em especificações precisas para engenharia, avalia trade-offs de arquitetura com visão de produto, identifica dependências críticas e riscos técnicos antes que virem problema." },
  pmproduct:{ id:"pmproduct",name:"Seu Flor", role:"PM de Produto",                      color:"#FDBA74", bg:"#7C2D12", emoji:"🧩", desc:"PM com foco profundo nas nuances do produto. Domina o comportamento do usuário por segmento, ciclo de vida do produto, posicionamento, priorização e coerência de proposta de valor. Garante que cada decisão sirva ao produto como um todo, não só à feature isolada." },
  change:   { id:"change",   name:"Marilda",role:"Gestão de Mudança",                  color:"#F0ABFC", bg:"#581C87", emoji:"🔄", desc:"Especialista em adoção e transição. Mapeia stakeholders impactados, antecipa resistências, estrutura comunicação, treinamento e rituais de acompanhamento. Garante que mudanças técnicas e de produto se convertam em adoção real." },
  security: { id:"security", name:"Paulão da mecanica",role:"Analista de Segurança da Informação",color:"#FDE68A", bg:"#713F12", emoji:"🔐", desc:"Segurança da informação e conformidade. Avalia riscos de exposição de dados, requisitos regulatórios (LGPD, BC), controles de acesso, autenticação e superfícies de ataque. Garante que as decisões de produto não criem brechas de segurança." }
